...
// 삭제모달 생성
$("button#myBtn").click( function(e) {
    let confirmModal = $(".modal#myModal")
    confirmModal.css("display", "block");
    // const rawModal = document.getElementById("myModal");

    const cancelBnt = $(".modal#myModal").find(".close").first();
    ...
    $("button.final-delete").data("id", visitId)

    confirmModal.find("div.writer").html($(this).data("writer"))
    confirmModal.find("div.contents").html($(this).data("contents"))
...
$(".final-delete").click( function(e) {
    ...
    const hashPwd = MD5($(".modal-content input[name='password']").val());
...
$("#visitor-message").submit( function(e) {
    ...
    writeInfo['password'] = MD5(password);
